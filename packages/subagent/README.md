...
| [`tool-vision-luna/`](tool-vision-luna/README.md) | Delegates image analysis to a configured vision model while keeping the parent request text-only | registers on `ctx.tools` |
