...
需要：`attachments` · `fs` · `sessions` · `llm` · `tools` · `subagents` · `systemPrompt` · `jobs`
...
来源：[`packages/subagent/tool-vision-luna/src/index.ts:42`](../packages/subagent/tool-vision-luna/src/index.ts)
