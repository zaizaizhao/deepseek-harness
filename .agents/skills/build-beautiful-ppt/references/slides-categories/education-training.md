...
- Learning task, teaching loop, density, and media roles
- Reference directions and page skeletons
- Visual-system constraints and execution protocol
- Delivery acceptance and reverse checks
...
Use the selected backend's PPTX validation and screenshot workflow to check overflow, overlap, truncation, garbled text, low contrast, missing page numbers, and missing sources. Review every final page individually; do not declare completion from thumbnails alone.
